...
const AirFreight = ({ containers, setContainers, totalQuantity, setTotalQuantity,
    ...
    return (
        <div>
            <Container>
                ...
                <section>
                    <h1 className='transport-route'>Transport route<span className='transport-route-mini-title'>(Air freight)</span></h1>
                    <Row>
                        <Col>
